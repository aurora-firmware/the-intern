---
title: "Progress Report — 2026-06-14"
...
Active specs: 9. Pending tasks: 0. In progress tasks: 0. Completed tasks: 99. Blocked tasks: 0. Open bugs: 1. Bugs in progress: 0. Resolved bugs: 9. ADRs: 8. Latest integration result: chore(bugs): merge B-010 self-contained user docs.
...
- Latest integration-test result: chore(bugs): merge B-010 self-contained user docs
...
|---|---|---|---|---|
| B-009 | Production extension.sock bind omits the documented 0700/0660 permission gate | medium | open | n/a |
