---
title: "Progress Report — 2026-06-19"
...
Active specs: 9. Pending tasks: 0. In progress tasks: 0. Completed tasks: 99. Blocked tasks: 0. Open bugs: 0. Bugs in progress: 0. Resolved bugs: 11. ADRs: 8. Latest integration result: chore(bugs): merge B-009 extension.sock permission gate.
...
- Latest integration-test result: chore(bugs): merge B-009 extension.sock permission gate
