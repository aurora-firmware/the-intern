---
title: "Progress Report — 2026-09-14"
...
Active specs: 14. Pending tasks: 0. In progress tasks: 0. Completed tasks: 201. Blocked tasks: 0. Open bugs: 0. Bugs in progress: 0. Resolved bugs: 46. ADRs: 15. Latest integration result: chore(tasks): merge T-201 invoke-skills-only-from-install-sh.
...
- Latest integration-test result: chore(tasks): merge T-201 invoke-skills-only-from-install-sh
