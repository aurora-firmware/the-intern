---
title: "Progress Report — 2026-08-11"
...
Active specs: 11. Pending tasks: 0. In progress tasks: 0. Completed tasks: 164. Blocked tasks: 0. Open bugs: 0. Bugs in progress: 0. Resolved bugs: 39. ADRs: 14. Latest integration result: chore(bugs): merge B-038 stale pi version companion skill.
...
- Latest integration-test result: chore(bugs): merge B-038 stale pi version companion skill
